...
int RS232_OpenComport(const char *port_name, int comport_number, int baudrate, const char *mode)
{
  int baudr,
      status;

  if((comport_number>99)||(comport_number<0))
  {
...
*/
  ...
  Cport[comport_number] = open(port_name, O_RDWR | O_NOCTTY | O_NDELAY);
...
int RS232_OpenComport(const char *_comport_name, int comport_number, int baudrate, const char *mode)
{

    char comport_name[99];
    comport_name[0] = '\\';
    comport_name[1] = '\\';
    comport_name[2] = '.';
    comport_name[3] = '\\';

    strcpy(comport_name+4, _comport_name);
